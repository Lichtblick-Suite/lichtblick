...
async function main(): Promise<void> {
  const { stdout, status } = await execOutput(
    ...
    [
      ...
      "--error",
      "--ignore",
      String.raw`used in module|^packages/(hooks|den|mcap|mcap-support)/|/studio-base/src/index\.ts|/studio-base/src/stories/|/studio-base/src/test/|/nodeTransformerWorker/typescript/userUtils|\.stories\.ts|/\.storybook/`,
