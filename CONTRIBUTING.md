...
Welcome, and thank you for your interest in contributing to Foxsight! We value your contributions and want to make the contributing experience enjoyable and rewarding for you. Here’s how you can get started:
...
At this time, first-class support for Foxsight is provided in English only. Localization into other languages is available on a best-effort basis, with translations provided by community volunteers.
...
The [`i18n` directory](packages/suite-base/src/i18n) contains translated (localized) strings for all languages supported by Foxsight.
