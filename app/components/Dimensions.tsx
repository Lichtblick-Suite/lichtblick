...
export default function Dimensions(props: Props): React.ReactElement | ReactNull {
  const [parentElement, setParentElement] = useState<HTMLDivElement | undefined>(undefined);
