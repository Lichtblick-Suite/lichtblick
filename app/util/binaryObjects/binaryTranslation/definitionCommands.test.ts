...
describe("definitionCommands", () => {
  ...
  it("optimize commands for MarkerArray", () => {
    ...
    expect(writer.getDefinitionCommands("visualization_msgs/MarkerArray")).toStrictEqual([
      ...
      DefinitionCommand.DYNAMIC_ARRAY, // Read header.sec and header.stamp
      DefinitionCommand.READ_FIXED_SIZE_DATA, // Read header.frame_id
      DefinitionCommand.READ_STRING, // Read ns
      DefinitionCommand.READ_STRING, // Read id, type, action, pose, scale, color, duration and frame_locked together
      DefinitionCommand.READ_FIXED_SIZE_DATA, // Read points
      DefinitionCommand.READ_DYNAMIC_SIZE_DATA, // Read colors
      DefinitionCommand.READ_DYNAMIC_SIZE_DATA, // Read text
      DefinitionCommand.READ_STRING, // Read mesh_resource
      DefinitionCommand.READ_STRING, // Read mesh_use_embedded_materials
