...
function Example({ color = { r: 0.2, g: 0.59, b: 0.2, a: 0.3 } }: { color?: Color }) {
  ...
  return (
    <Worldview
      ...
      hideDebug
    >
      <PoseMarkers markers={[marker, markerWithoutColor, markerWithSettings]} />
    </Worldview>
  );
}
...
storiesOf("panels/ThreeDimensionalViz/commands/PoseMarkers", module)
  ...
  .add("alpha_0.3", () => <Example />)
  .add("alpha_0.5, color_50,200,50,0.8", () => (
    <Example color={{ r: 0.2, g: 0.78, b: 0.2, a: 0.8 }} />
  ))
  .add("alpha 0.8", () => <Example />)
  .add("alpha 1", () => <Example />);
